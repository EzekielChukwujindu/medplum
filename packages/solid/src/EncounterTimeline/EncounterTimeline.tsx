...
export interface EncounterTimelineProps extends Pick<ResourceTimelineProps<Encounter>, 'getMenu'> {
  /** Encounter resource or reference */
  readonly encounter: Encounter | Reference<Encounter>;
}

/**
 * EncounterTimeline displays a timeline for an Encounter resource.
 * Includes communications and media attached to the encounter.
 * @param props
 */
