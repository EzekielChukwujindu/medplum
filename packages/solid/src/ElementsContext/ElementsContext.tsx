...
/**
 * Default ElementsContext value.
 */
const defaultElementsContext: ElementsContextType = {
  path: '',
...
/**
 * ElementsContext provides schema information for rendering FHIR elements.
 * Used by BackboneElementDisplay and related components.
 */
export const ElementsContext = createContext<ElementsContextType>(defaultElementsContext);

/**
 * Hook to access the current ElementsContext.
 */
export function useElementsContext(): ElementsContextType {
  const ctx = useContext(ElementsContext);
  return ctx ?? defaultElementsContext;
}
...
/**
 * Filters elements to render, excluding system properties and nested paths.
 * @param inputElements
 */
