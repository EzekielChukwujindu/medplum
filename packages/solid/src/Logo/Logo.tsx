...
// Check for MEDPLUM_LOGO_URL in environment
declare global {
  interface ImportMeta {
    readonly env?: {
      readonly MEDPLUM_LOGO_URL?: string;
    };
  }
}

/**
 * Logo component displays the Medplum logo.
 * Can be customized with a custom logo URL via MEDPLUM_LOGO_URL environment variable.
 * @param props
 */
export function Logo(props: LogoProps): JSX.Element {
  ...
  return (
    <Show
      when={!overrideUrl}
      fallback={<img src={overrideUrl as string} alt="Logo" style={{ "max-height": `${props.size}px` }} />}
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 180" style={{ width: `${props.size}px`, height: `${props.size}px` }}>
