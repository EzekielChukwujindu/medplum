...
/**
 * A Solid primitive that returns a cached version of a signed S3 URL if available and not expired.
 * This maintains 100% functional parity with the React version.
